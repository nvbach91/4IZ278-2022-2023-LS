		...
		<div class="col mb-3">
			<div class="card h-100">
				...
				<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
					<div class="text-center">
						<a href="addToCart?id=<?php echo $product['id_product'] ?>&flag=add" class="btn btn-outline-dark mt-auto ms-2 me-2">Add to cart</a>
						<a href="addToCart?id=<?php echo $product['id_product'] ?>&flag=buy" class="btn btn-outline-dark mt-auto ms-2 me-2">Buy</a>
					</div>
				</div>
			</div>
		</div>
