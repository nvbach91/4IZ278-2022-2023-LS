...
<div id="topProducts" class="carousel slide" data-ride="carousel">
	<ol class="carousel-indicators">
		<?php foreach ($slides as $slide): ?>
			<li data-target="#topProducts" data-slide-to="<?php echo $slide['id_slide'] ?>"
				class="<?php echo $slide['id_slide'] == 1 ? 'active' : '' ?>"></li>
		<?php endforeach; ?>
	</ol>
	<div class="carousel-inner" role="listbox">
		<?php foreach ($slides as $slide): ?>
			<div class="carousel-item slide <?php echo $slide['id_slide'] == 1 ? 'active' : '' ?>">
				<img class="d-block slide-image mb-xl-5" src="<?php echo $slide['img']; ?>"
					 alt="Product: <?php echo $slide['title']; ?>">
				<div class="carousel-caption d-none d-md-block">
					<h4 class="slide-text"><?php echo $slide['title']; ?></h4>
				</div>
			</div>
		<?php endforeach; ?>
	</div>
