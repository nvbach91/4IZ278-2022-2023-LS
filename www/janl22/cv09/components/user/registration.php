...
if ($formSubmitted) {
	...
	if (empty($fieldStatuses)) {
		...
		$usersDB = new UsersDB();
		$fieldStatuses['registration'] = $usersDB->registerUser(new User($mail, password_hash($pass, PASSWORD_BCRYPT), $name, $surname, $phone))['message'];
			...
			<div class="card col-xl-6">
				<div class="card-body">
					...
					<div class="mt-4 w-full justify-content-center">
						<form id="registration" method="POST" action="<?php echo $GLOBALS['request']; ?>">
						...
						<a href="login?mail=<?php echo $mail ?>">
