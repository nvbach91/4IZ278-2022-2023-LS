		...
		<?php foreach ($_SESSION['cart'] as $item): ?>
			<tr>
				...
				<td class="text-center">
					<a href="removeFromCart?id=<?php echo $item['id_product']; ?>&flag=one"
					   class="badge bg-dark text-white ms-2 me-2 rounded-pill">
						<i class="bi bi-dash"></i>
					</a>
					<?php echo $item['count']; ?>
					<a href="addToCart?id=<?php echo $item['id_product']; ?>&flag=buy"
					   class="badge bg-dark text-white ms-2 me-2 rounded-pill">
				...
				<td>
					<a href="removeFromCart?id=<?php echo $item['id_product']; ?>&flag=all"
