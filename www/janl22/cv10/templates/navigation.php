	...
	<div class="container px-4 px-lg-5">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
				...
				<?php if (hasPermission('store.manager')): ?>
					<li class="nav-item"><a class="nav-link" aria-current="page"
											href="<?php echo $GLOBALS['siteRoot'] ?>products">Edit products</a></li>
				<?php endif ?>
				<?php if (hasPermission('users.manage')): ?>
					<li class="nav-item"><a class="nav-link" aria-current="page"
											href="<?php echo $GLOBALS['siteRoot'] ?>users">Manage users</a></li>
				<?php endif ?>
			</ul>
			<div class="d-flex">
				<a class="me-2" href="<?php echo $GLOBALS['siteRoot'] ?>cart" style="text-decoration: none">
					<button class="btn btn-outline-dark">
						<i class="bi-cart-fill me-1"></i>
						Cart
						<span
							class="badge bg-dark text-white ms-1 rounded-pill"><?php echo countItemsInCart(); ?></span>
					</button>
				</a>
				<?php if (isLoggedIn()): ?>
				...
				<?php else: ?>
					<a href="<?php echo $GLOBALS['siteRoot'] ?>login" style="text-decoration: none">
						<button class="btn btn-outline-dark">
