...
switch ($GLOBALS['path']) {
	...
	case 'editProductOptimistic':
		require_once __DIR__ . '/../components/product/editOptimistic.php';
		break;

	case 'editProductPessimistic':
		require_once __DIR__ . '/../components/product/editPessimistic.php';
		break;

	case 'newProduct':
		require_once __DIR__ . '/../components/product/newProduct.php';
		break;
	...
	case 'logout':
		require_once __DIR__ . '/../components/user/auth/logout.php';
		break;
