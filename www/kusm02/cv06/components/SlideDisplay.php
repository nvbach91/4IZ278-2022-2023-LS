<?php require_once __DIR__ . '/../db/SliderDatabase.php'; ?>

<?php 
$slidesDB = new SliderDatabase();
...
<div id="slider" class="carousel slide my-4" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item slide <?php echo $index == 0 ? 'active' : ''; ?>">
            <img class="d-block img-fluid slide-image" src="<?php echo $slide['img']; ?>" alt="mango-product-image">
        </div>
        <?php endforeach; ?>
    </div>
