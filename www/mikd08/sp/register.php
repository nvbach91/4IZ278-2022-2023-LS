...
if (isset($_POST["register"])) {
    ...
    $stmt = $pdo->prepare('INSERT INTO user(user_id, username, password, name, email, phone, address, isAdmin) VALUES (user_id, :username, :password, :name, :email, :phone, :address, "false")');
    $stmt->execute([
        "username" => $username,
