...
$count = $db->query('SELECT COUNT(product_id) FROM cv10_products')->fetchColumn();
$stmt = $db->prepare('SELECT * FROM cv10_products ORDER BY product_id DESC LIMIT 10 OFFSET ?');
...
<main class="container">
    ...
    <div class="products">
        ...
        <div class="product">
            ...
            <div><?php echo substr($product['img'], 0, 40); ?>...</div>
