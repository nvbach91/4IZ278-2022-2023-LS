...
abstract class Database implements DatabaseOperations
{
    ...
    public function fetchByIds($ids) {
        ...
        $statement = $this->db_conn->prepare("SELECT * FROM `$this->db_table` WHERE `$this->db_table_pk` IN ($in)");
    ...
    {
        $statement = $this->db_conn->prepare("DELETE FROM `$this->db_table` WHERE `$this->db_table_pk` = :id");
