...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#007bff;">
        <a class="navbar-brand" href="https://esotemp.vse.cz/~smap01/cv09/index.php">E-shop</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="https://esotemp.vse.cz/~smap01/cv09">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="create-item.php">Create item</a>
                </li>
            </ul>
            <a class="my-2 my-lg-0" href="profile.php" style="margin-right:5px;color:white;"><?php echo isset($_COOKIE['name']) ? $_COOKIE['name'] : ''; ?></a>
            <?php
