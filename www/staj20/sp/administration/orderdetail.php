...
$orderView = new Order();
if(isset($_GET['status']) && $csrf_good){
    $orderView->AddOrderStatus($orderId,$_GET['status'],$_GET['information']);
}
...
<body>
    <div class="wrapper">
        ...
        <main>
            ...
            <a class="link-button" href="allorders.php">Zpět</a>
            ...
            <h3>Přidat status objednávky</h3>
            <form>
                <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token'];?>">             
                <input type="hidden" name="order_id" value="<?php echo $_GET['order_id'];?>">
                <label for="status">Status*:</label>
                <br><input type="text" name="status" required>
                <br><label for="information">Informace:</label>
                <br><input type="text" name="information">
                <br><button class="link-button" type="submit" name="submit" value="Odeslat">Odeslat</button>
            </form>
