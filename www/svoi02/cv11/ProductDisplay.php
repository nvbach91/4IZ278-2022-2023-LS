          ...
          <div class="card h-100 product">
            ...
            <div class="my-buttons">
              ...
              <?php if ($_SESSION['auth_level'] > 1) : ?>
                <!-- <a class="btn btn-outline-dark card-button" href="./optimistic-edit.php?product_id=<?php echo $product['product_id'];?>">
                    Edit
                </a> -->
                <a class="btn btn-outline-dark card-button" href="./pessimistic-edit.php?product_id=<?php echo $product['product_id'];?>">
                    Edit
                </a>
