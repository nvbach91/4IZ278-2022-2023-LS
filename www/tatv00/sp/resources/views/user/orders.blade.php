                        ...
                        <thead>
                            <tr>
                                <th class="border-b border-gray-200 p-2 text-center">
                                    <a href="{{ route('user.orders', ['sort_by' => 'order_num', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc', 'search' => $search]) }}">Order Number</a>
                                </th>
                                <th class="border-b border-gray-200 p-2 text-center">Total Sum</th>
                                <th class="border-b border-gray-200 p-2 text-center">
                                    <a href="{{ route('user.orders', ['sort_by' => 'status', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc', 'search' => $search]) }}">Status</a>
                                </th>
                                <th class="border-b border-gray-200 p-2 text-center">
                                    <a href="{{ route('user.orders', ['sort_by' => 'created_at', 'sort_order' => $sortOrder == 'asc' ? 'desc' : 'asc', 'search' => $search]) }}">Date</a>
                                </th>
