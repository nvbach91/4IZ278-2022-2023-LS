...
if (isset($_GET['id']))
    $user = $usersDatabase->getUserById($_GET['id']);
    ...
    <div class="card-body text-dark p-4">
        <div class="row justify-content-center text-center">
            <div class="col-md-8 col-lg-6">
                <div class="d-flex mb-2 mb-3 mx-auto justify-content-center align-items-center rounded-circle bg-light" style="width: 250px; height: 250px; 
                ...
                <h5 class="card-subtitle text-muted mb-3"><?php echo $user['role'] ?></h5>
