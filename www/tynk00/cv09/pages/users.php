                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card shadow rounded">
                        <div class="card-body text-center mx-auto">
                            <div class="d-flex mb-2 justify-content-center align-items-center rounded-circle bg-light" style="width: 150px; height: 150px; 
                            ...
                            <p class="card-text text-muted"><?php echo $user['role'] ?></p>
