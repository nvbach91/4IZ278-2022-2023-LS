...
<div class="card w-100 shadow-lg my-5 rounded text-bg-dark" style="width: 18rem;">
    ...
    <ul class="list-group list-group-flush">
        ...
        <a href="https://github.com/nvbach91/4IZ278-2022-2023-LS/wiki/LAB10" class="list-group-item list-group-item-action" aria-current="true">
            Zadání
        </a>
        <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="list-group-item list-group-item-action" aria-current="true">
            Neklikat!!!
        </a>
    </ul>
