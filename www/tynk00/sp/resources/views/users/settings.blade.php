                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('user.update') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <label for="email"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Váš email') }}</label>
                            ...
                            <div class="form-group row">
                                ...
                                <label for="name"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Přezdívka') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="password-confirm"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Heslo znovu') }}</label>
