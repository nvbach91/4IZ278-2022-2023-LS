...
<a href="#products" class="group">
    ...
    <div>
        ...
        <div>
            <a href="./buy.php?good_id=<?php echo $product['good_id'] ?>">Buy</a>
            <a href="./edit-item.php?good_id=<?php echo $product['good_id'] ?>">Edit</a>
            <a href="./delete-item.php?good_id=<?php echo $product['good_id'] ?>">Delete</a>
        </div>
    </div>
