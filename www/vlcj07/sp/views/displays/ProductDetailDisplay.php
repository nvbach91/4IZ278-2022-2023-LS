...
<div>
    ...
    <?php if (isset($_SESSION['user_id'])) : ?>
        <div class="m-2 text-center">
            <a class="w-full whitespace-nowrap text-black dark:text-white bg-orange-100 hover:bg-orange-200 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700" href="../controllers/buy.php?product_id=<?php echo $product['product_id'] ?>">Přidat do košíku</a>
        </div>
    <?php endif; ?>
</div>