...
class UsersDB extends Database
{
    ...
    public function create(array $record)
    {
        ...
        if (!isset($record['name']) || !isset($record['age'])) {
        ...
        echo "User " . $record['name'] . " was created. <br>";
        return self::RESULT_SUCCESS;
    }
    ...
    public function fetchByID(int $id)
    {
        ...
        foreach ($this->tableRows as $row) {
            if ($row['id'] === $id) {
                ...
                echo "Product id: " . $row['id'] . "; name: " . $row['name'] . "; age: " . $row['age'] . "<br>";
                echo "--------------<br><br>";
                return $row;
            }
        }
        
        echo "No user with id " . $id . " was found.<br>";
    ...
    public function fetchByName(string $name)
    {
        ...
        foreach ($this->tableRows as $row) {;
            if ($row['name'] === $name) {
                echo "Fetched user with name " . $name . ":<br>";
        ...
        echo "No user with name " . $name . " was found.<br>";
        return null;
    }
    ...
    public function update(int $id, array $record)
    {
        ...
        echo "User with id " . $id . " was updated.<br>";
        return self::RESULT_SUCCESS;
    }
    ...
    public function fetchAll()
    {
        ...
        echo "Fetched all rows from Users table:<br>";
