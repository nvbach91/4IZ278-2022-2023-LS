...
if (isset($_POST['t1'])){
  ...
  foreach ($data as $name) {
    ...
    foreach ($data as $mail) {
      if ($mail['mail'] == '1' or !filter_var($_POST['mail'], FILTER_VALIDATE_EMAIL)) {
        $mailerr = true;
      }
...
if (checkPasswordStrength($_POST["pass"])) {
        ...
        <div class="rrightside">
          <div class="registration">
            <div class="form-body">
              ...
              if ($mailerr == true){
                echo "This e-mail is already taken or isn't in the right format.<br>";
              }
              if ($errStrength == true){
                echo "You need to use upper and lower cases with numbers.<br>";
              }
              ?>
