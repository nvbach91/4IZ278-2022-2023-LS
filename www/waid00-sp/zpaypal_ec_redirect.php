...
?>
            ...
            <form class="form" action="zpaypal_ec_mark.php" method="POST">
               <div class="row-fluid">
                  <div class="span6 inner-span" id="mark-form-container">
                        ...
                        <tr><td width="30%">First Name</td><td><input class="mark-input-field" type="text" id="L_PAYMENTREQUEST_FIRSTNAME" name="L_PAYMENTREQUEST_FIRSTNAME" value="Pam"/></td></tr>
                        <tr><td>Last Name:</td><td><input class="mark-input-field" type="text" id="L_PAYMENTREQUEST_LASTNAME" name="L_PAYMENTREQUEST_LASTNAME" value="Jones"/></td></tr>
                        <tr><td>Address</td><td><input class="mark-input-field" type="text" id="PAYMENTREQUEST_0_SHIPTOSTREET" name="PAYMENTREQUEST_0_SHIPTOSTREET" value="55 East 52nd Street"/></td></tr>
                        <tr><td>Address 1</td><td><input class="mark-input-field" type="text" id="PAYMENTREQUEST_0_SHIPTOSTREET2" name="PAYMENTREQUEST_0_SHIPTOSTREET2" value="21st Floor"/></td></tr>
                        <tr><td>City:</td><td><input class="mark-input-field" type="text" id="PAYMENTREQUEST_0_SHIPTOCITY" name="PAYMENTREQUEST_0_SHIPTOCITY" value="New York" /></td></tr>
                        <tr><td>State:</td><td><input class="mark-input-field" type="text" id="PAYMENTREQUEST_0_SHIPTOSTATE" name="PAYMENTREQUEST_0_SHIPTOSTATE" value="NY" /></td></tr>
                        <tr><td>Postal Code:</td><td><input class="mark-input-field" type="text" id="PAYMENTREQUEST_0_SHIPTOZIP" name="PAYMENTREQUEST_0_SHIPTOZIP" value="10022" /></td></tr>
                        ...
                        <tr><td>Telephone:</td><td><input class="mark-input-field" type="text" id="PAYMENTREQUEST_0_SHIPTOPHONENUM" name="PAYMENTREQUEST_0_SHIPTOPHONENUM" value="" maxlength="12"/></td></tr>
   ...
   <div class="span3">
    ...
    var CREATE_PAYMENT_URL  = './zpaypal_ec_mark.php';
    var EXECUTE_PAYMENT_URL  = './zpaypal_return.php';
