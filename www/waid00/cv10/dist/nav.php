        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-ite nav-item"><a class="nav-link" href="settings.php">settings</a></li>
                    <li class="nav-ite nav-item"><a class="nav-link" href="world-clock.php">world-clock</a></li>
                    <li class="nav-ite nav-item"><a class="nav-link" href="logout.php">logout</a></li>
                    <?php
                    if ($_SESSION['privilege'] >= 1) { ?> <li class="nav-ite nav-item"><a class="nav-link" href="addItem.php"><?php echo 'addItem'; ?></a></li>
                        <li class="nav-ite nav-item"><a class="nav-link" href="users.php">users</a></li> <?php ; } ?>
